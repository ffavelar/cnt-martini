...
../insane.py -l POPC:1 -salt 0.15 -x $EDGE -y $EDGE -z $HEIGHT -center -pbc cubic -sol W:9 -sol WF:1 -f 4cnt.gro -p system4.top -o system4.gro -ring

sed -i 's/Protein       /cnt-12-8-f11-SNda/g' system.top

printf '2|3|9|10 \n 4|5|6|7|8|11|12|13|14 \n name 15 Membrane \n name 16 Water \n q \n' | gmx make_ndx -f system4.gro -o index4.ndx
